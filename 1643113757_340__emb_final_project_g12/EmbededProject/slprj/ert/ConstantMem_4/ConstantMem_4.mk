###########################################################################
## Makefile generated for component 'ConstantMem_4'. 
## 
## Makefile     : ConstantMem_4.mk
## Generated on : Mon Jan 24 05:56:42 2022
## Final product: ./ConstantMem_4_rtwlib.a
...
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = ConstantMem_4_rtwlib.a
...
PRODUCT = ./ConstantMem_4_rtwlib.a
...
DEFINES_STANDARD = -DMODEL=ConstantMem_4 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/ert/ConstantMem_4/ConstantMem_4.c
...
%.o : $(START_DIR)/slprj/ert/ConstantMem_4/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/slprj/ert/ConstantMem_4/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/ConstantMem_4/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ConstantMem_4.o : $(START_DIR)/slprj/ert/ConstantMem_4/ConstantMem_4.c
	$(CC) $(CFLAGS) -o "$@" "$<"
