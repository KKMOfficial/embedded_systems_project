###########################################################################
## Makefile generated for component 'outside'. 
## 
## Makefile     : outside.mk
## Generated on : Mon Jan 24 05:56:50 2022
## Final product: ./outside_rtwlib.a
...
DEFINES_STANDARD = -DMODEL=outside -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/ert/outside/outside.c
...
%.o : $(START_DIR)/slprj/ert/outside/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/slprj/ert/outside/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/outside/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
outside.o : $(START_DIR)/slprj/ert/outside/outside.c
	$(CC) $(CFLAGS) -o "$@" "$<"
