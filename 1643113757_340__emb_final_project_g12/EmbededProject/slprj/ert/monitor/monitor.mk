###########################################################################
## Makefile generated for component 'monitor'. 
## 
## Makefile     : monitor.mk
## Generated on : Mon Jan 24 05:56:48 2022
## Final product: ./monitor_rtwlib.a
...
DEFINES_STANDARD = -DMODEL=monitor -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/ert/monitor/monitor.c
...
%.o : $(START_DIR)/slprj/ert/monitor/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/slprj/ert/monitor/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/monitor/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
monitor.o : $(START_DIR)/slprj/ert/monitor/monitor.c
	$(CC) $(CFLAGS) -o "$@" "$<"
