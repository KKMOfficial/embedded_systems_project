###########################################################################
## Makefile generated for component 'joinX_1'. 
## 
## Makefile     : joinX_1.mk
## Generated on : Mon Jan 24 05:56:46 2022
## Final product: ./joinX_1_rtwlib.a
...
DEFINES_STANDARD = -DMODEL=joinX_1 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/ert/joinX_1/joinX_1.c
...
%.o : $(START_DIR)/slprj/ert/joinX_1/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/slprj/ert/joinX_1/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/joinX_1/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
joinX_1.o : $(START_DIR)/slprj/ert/joinX_1/joinX_1.c
	$(CC) $(CFLAGS) -o "$@" "$<"
