...
void set_test_input(int*,double*,double*);
...
typedef struct {
  double X_u;                          /* '<Root>/B_-1_-1' */
  double X_x1;                         /* '<Root>/B_-1_-1' */
  double X_x2;                         /* '<Root>/B_-1_-1' */
  double X_x3;                         /* '<Root>/B_-1_-1' */
  double X_x4;                         /* '<Root>/B_-1_-1' */
  double C_A[16];                      /* '<Root>/B_-1_-1' */
  double C_b[4];                       /* '<Root>/B_-1_-1' */
  double C_c[4];                       /* '<Root>/B_-1_-1' */
  double C_x0[4];                      /* '<Root>/B_-1_-1' */
  double C_off[4];                     /* '<Root>/B_-1_-1' */
  double C_on[4];                      /* '<Root>/B_-1_-1' */
  double C_get[4];                     /* '<Root>/B_-1_-1' */
  double C_diff[4];                    /* '<Root>/B_-1_-1' */
} ExtU_controller_T;
...
int H_h1(){return controller_Y.H_h1;}
int H_h2(){return controller_Y.H_h2;}
int H_h3(){return controller_Y.H_h3;}
int H_h4(){return controller_Y.H_h4;}

void set_test_input(int*X_in,double*C_get_in,double*C_diff_in){
  controller_U.X_x1 = X_in[0];
  controller_U.X_x2 = X_in[1];
  controller_U.X_x3 = X_in[2];
  controller_U.X_x4 = X_in[3];
  for (int i = 0; i < 4; i++)
  {
    controller_U.C_get[i]=C_get_in[i];
    controller_U.C_diff[i]=C_diff_in[i];  
  }
}